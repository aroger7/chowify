        ...
        all: state.all.map(
          recipe => (recipe.id === action.payload.recipeId
            ? Object.assign({}, recipe, {
              directions: recipe.directions.concat(action.payload.direction)
            })
            : recipe)
        )
      });
          ...
          recipe => (recipe.id === action.payload.recipeId
            ? Object.assign({}, recipe, {
              directions: recipe.directions.map(
                (direction, index) => (index === action.payload.directionId
          ...
          recipe => (recipe.id === action.payload.recipeId
            ? Object.assign({}, recipe, {
              ingredients: recipe.ingredients.map(
                (ingredient, index) => (index === action.payload.ingredientId
      ...
      return Object.assign({}, state, {
        all: state.map(
          recipe => (recipe.id === action.payload.recipeId
            ? Object.assign({}, recipe, {
              directions:
                    action.payload.directionId < recipe.directions.length - 1
                      ? [
                        ...recipe.directions.slice(
                          0,
                          action.payload.directionId
                        ),
                        recipe.directions[action.payload.directionId + 1],
                        recipe.directions[action.payload.directionId],
                        ...recipe.directions.slice(
                          action.payload.directionId + 2
                        )
                      ]
                      : recipe.directions
            })
